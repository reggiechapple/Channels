        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CauseId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Campaigns_Members_InitiatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CauseSupporters", x => new { x.SupporterId, x.CauseId });
                    table.ForeignKey(
                        name: "FK_CauseSupporters_Causes_CauseId",
                        column: x => x.CauseId,
                        principalTable: "Causes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CauseSupporters_Members_SupporterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Channels_Members_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignVolunteers", x => new { x.VolunteerId, x.CampaignId });
                    table.ForeignKey(
                        name: "FK_CampaignVolunteers_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CampaignVolunteers_Members_VolunteerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Donations_Members_DonorId",
                        column: x => x.DonorId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VolunteerRequests_Members_VolunteerId",
                        column: x => x.VolunteerId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChannelMessages_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChannelSubscribers", x => new { x.SubscriberId, x.ChannelId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Campaigns_InitiatorId",
                table: "Campaigns",
                column: "InitiatorId");

            migrationBuilder.CreateIndex(
                name: "IX_CampaignVolunteers_CampaignId",
                table: "CampaignVolunteers",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_CauseSupporters_CauseId",
                table: "CauseSupporters",
                column: "CauseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelMessages_MemberId",
                table: "ChannelMessages",
                column: "MemberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelSubscribers_ChannelId",
