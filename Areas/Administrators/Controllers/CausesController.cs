...
namespace Channels.Areas.Administrators.Controllers
{
    ...
    public class CausesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Category")] Cause cause)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Name,Category")] Cause cause)
        {
            if (id != cause.Id)
            {
                return NotFound();
